...
DROP POLICY IF EXISTS "Users can view own data files" ON data_files;
DROP POLICY IF EXISTS "Users can insert own data files" ON data_files;
DROP POLICY IF EXISTS "Users can update own data files" ON data_files;
DROP POLICY IF EXISTS "Users can delete own data files" ON data_files;
